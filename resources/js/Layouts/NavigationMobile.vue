    ...
    <aside v-show="$page.props.showingMobileMenu" class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden">
      <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
          ...
          <li v-if="$page.props.auth.user.role == 1" class="relative px-6 py-3">
          ...
          <li v-if="$page.props.auth.user.role == 2" class="relative px-6 py-3">
          ...
          <li class="relative px-6 py-3">
            <ResponsiveNavLink :href="route('admin.classrooms.index')" :active="route().current('admin.classrooms.index')">
              <template #icon>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
          ...
          <li class="relative px-6 py-3" v-if="$page.props.auth.user.role == 2">
          ...
          <li class="relative px-6 py-3" v-if="$page.props.auth.user.role == 2">
            <ResponsiveNavLink :href="route('admin.exams.index')" :active="route().current('admin.exams.index')">
              <template #icon>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
          ...
          <li class="relative px-6 py-3" v-if="$page.props.auth.user.role == 3">
            <ResponsiveNavLink :href="route('lecturer.questions.index')" :active="route().current('lecturer.questions.index')">
              <template #icon>
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path
