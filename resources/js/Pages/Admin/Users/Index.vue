      ...
      <div class="overflow-x-auto w-full">
        ...
        <table class="w-full whitespace-no-wrap">
          ...
          <tr v-for="user in users.data" :key="user.id" class="text-gray-700">
            ...
            <td class="px-4 py-3 text-sm">
              <span class="bg-green-200 rounded-xl py-1 px-2">
                {{ user.status}}
              </span>
            </td>
            <td class="px-4 py-3 text-sm">
            ...
            <td class="px-6 py-3 text-sm">
              <Link :href="route('admin.users.edit', user.id)" class="inline-flex items-center px-4 py-2 bg-yellow-600 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
