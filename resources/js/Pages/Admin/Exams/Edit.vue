<template>
    ...
    <AuthenticatedLayout>
      ...
      <div class="p-4 bg-white rounded-lg shadow-xs">
        ...
        <form @submit.prevent="submit">
          ...
          <div> 
            <InputLabel for="course_id" value="Course I:"></InputLabel>
  ...
  <script setup>
    ...
    const form = useForm({
        name: props.exams.name,
        course_id: props.exams.course_id,
        date: props.exams.date,
        time: props.exams.time,
    });
    const submit = () => {
      // form.post(route('register'), {
      form.post(route('admin.exams.update'), {
