    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
      ...
      <form @submit.prevent="submit">
        ...
        <div>
            ...
            <input v-model="form.email" id="email" class="block mt-1 w-full" type="email" name="email" autofocus autocomplete="email" value="{{user.email}}"/>
        </div>
        <div>
            <InputLabel for="password" value="password" />

            <input v-model="form.password" id="password" class="block mt-1 w-full" type="password" name="password" autofocus autocomplete="password" value="{{user.password}}"/>
        </div>
